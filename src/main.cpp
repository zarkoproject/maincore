...
const string strMessageMagic = "Zarko Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 100) // ZAR
    {
        nSubsidy = 30000000 * COIN;
    }
    else if(pindexBest->nHeight < 720000) //   2016000000 POW approx
    {
        nSubsidy = 2800 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Zarko", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Zarko born today";
        CTransaction txNew;
        txNew.nTime = 1547626490;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x8561b7ea8b277a6c4cf6d65bb1f88676d979feb63ca924a26a3fd0a6f433b045"));
