	...
	stakeForCharityDialog(0)
{
    updateStyle();
    resize(1000, 740);
    setWindowTitle(tr("Zarko") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Zarko address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&Zarko Website"), this);
	pioAction->setToolTip(tr("Visit the Official Zarko website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk Zarko discussion thread"));
	twitterAction = new QAction(QIcon(":/icons/twitter"), tr("&@Zarko"), this);
	twitterAction->setToolTip(tr("Visit the Official Zarko Twitter"));	
	chainAction = new QAction(QIcon(":/icons/explorer"), tr("&Zarko Slack"), this);
	chainAction->setToolTip(tr("Join Zarko Slack"));	
	githubAction = new QAction(QIcon(":/icons/github"), tr("&Github"), this);
	githubAction->setToolTip(tr("Visit the Official Zarko Github"));	
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Zarko"), this);
    aboutAction->setToolTip(tr("Show information about Zarko"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Zarko"));
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar2 = addToolBar(tr("Zarko top-logo"));
	...
	QToolBar *toolbar4 = addToolBar(tr("Zarko side-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Zarko client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Zarko client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Zarko network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        if (strStatusBarWarnings.isEmpty())
        {
            ...
            progressBarLabel->setVisible(false);
            progressBar->setFormat(tr("Synchronizing with the Zarko network:   %n block(s) remaining", "", nRemainingBlocks));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Zarko address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateStyle()
{
    ...
    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/Zarko.qss";
