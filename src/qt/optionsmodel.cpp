...
void OptionsModel::Init()
{
    ...
    fUseZarkoTheme = settings.value("fUseZarkoTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UseZarkoTheme:
            return QVariant(fUseZarkoTheme);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseZarkoTheme:
            fUseZarkoTheme = value.toBool();
            settings.setValue("fUseZarkoTheme", fUseZarkoTheme);
            break;
        default:
            break;
        }
